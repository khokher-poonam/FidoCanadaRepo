...
public class ExcelData extends TestBase {
    private String dataFileSheet = "Fido_Details.xlsx";
    ...
    @DataProvider
    public Iterator<Object[]> fido_dataProvider()
    {
        return getDataFromSheet("fido-details").iterator();
    }
}